 ...
 */
public class MedianStandardDeviationDrive extends Configured implements Tool
{
    /**
     * @param args
     * @return
    ...
    public int run(String[] args) throws Exception
    {
        ...
        Job job = Job.getInstance(conf, "MedianStandardDeviation Hadoop Job");
        job.setJarByClass(MedianStandardDeviationDrive.class);
        ...
        System.out.println("MedianStandardDeviation Hadoop Job start!");
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        int exitCode = ToolRunner.run(new MedianStandardDeviationDrive(), otherArgs);
        if (exitCode == 0)
        {
