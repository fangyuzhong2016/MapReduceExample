 ...
 */
public class CountAverageDrive extends Configured implements Tool
{
    /**
     * @param args
     * @return
    ...
    public int run(String[] args) throws Exception
    {
        ...
        Job job = Job.getInstance(conf, "CountAverage Hadoop Job");
        job.setJarByClass(CountAverageDrive.class);
        ...
        job.setMapOutputValueClass(CountAverageObject.class);

        //设置输出类型
        job.setOutputKeyClass(IntWritable.class);
        job.setOutputValueClass(CountAverageObject.class);

        System.out.println("CountAverage Hadoop Job start!");
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        int exitCode = ToolRunner.run(new CountAverageDrive(), otherArgs);
        if (exitCode == 0)
        {
